...
@section('content')
    ...
    <section>
        <h2 class="section-title">{{ trans('public.consultants') }}</h2>
                                        ...
                                        <td class="text-right align-middle">
                                            <div class="btn-group dropdown table-actions">
                                                ...
                                                <div class="dropdown-menu">
                                                    ...
                                                    <a href="/panel/manage/consultants/{{ $user->id }}/edit" class="btn-transparent webinar-actions d-block mt-10">{{ trans('public.edit') }}</a>
                                                    @if(auth()->user()->isAdmin())
                                                    <a href="/panel/manage/consultants/{{ $user->id }}/delete" class="webinar-actions d-block mt-10 delete-action">{{ trans('public.delete') }}</a>
                                                    @endif
                                                </div>
                                            </div>
                                        </td>
