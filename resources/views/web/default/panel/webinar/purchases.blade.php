                        ...
                        <div class="webinar-card webinar-list d-flex">
                            ...
                            <div class="webinar-card-body w-100 d-flex flex-column">
                                <div class="d-flex align-items-center justify-content-between">
                                    ...
                                    @if($authUser->role_name == "user" && !empty($webinar->downloadable))
                                ...
                                @php
                                    $percent = $webinar->getProgress(auth()->user()->id);
                                    $expectedProgress = $webinar->getExpectedProgress(auth()->user()->id);
                                ...
                                <div class="ml-15 mt-1 font-14 font-weight-500 text-right">
                                    <span class="font-14 font-weight-500 {{ ($percent >= $expectedProgress) ? "text-primary" : "text-danger"}}">
                                        {{ trans('public.course_progress_percent',['percent' => $percent]) }}
                                    </span>
                                    <br />
