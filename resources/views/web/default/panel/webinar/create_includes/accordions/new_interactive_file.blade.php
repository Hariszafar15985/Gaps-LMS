            ...
            <div class="js-content-form file-form" data-action="/panel/files/{{ !empty($file) ? $file->id . '/update' : 'store' }}">
                ...
                <div class="row">
                    <div class="col-12 col-lg-6">
                        ...
                        <div class="js-interactive-file-name-input form-group">
                        ...
                        <div class="form-group mt-20">
                            <div class="d-flex align-items-center">
                                <label class="cursor-pointer align-items-center input-label mt-5" for="fileStatusSwitch{{ !empty($file) ? $file->id : '_record' }}">{{ trans('public.active') }}</label>
