...
<div class="panel-sidebar pt-50 pb-25 px-25" id="panelSidebar">
    ...
    <ul class="sidebar-menu pt-10 @if(!empty($authUser->userGroup)) has-user-group @endif" data-simplebar @if((!empty($isRtl) and $isRtl)) data-simplebar-direction="rtl" @endif>
        ...
        {{-- Students --}}
        <li class="sidenav-item {{ (request()->is('panel/manage/students') or request()->is('panel/manage/students*')) ? 'sidenav-item-active' : '' }}">
            ...
            <div class="collapse {{ (request()->is('panel/manage/students') or request()->is('panel/manage/students*')) ? 'show' : '' }}" id="studentsCollapse">
        ...
        {{-- Sub-Managers --}}
        @if ($authUser->isOrganizationManager() )
        ...
        {{-- Consultants --}}
        @if($authUser->isOrganizationManager() || $authUser->isOrganizationSubManager())  
        ...
        {{-- Break - being handled from student listing instead --}}
        {{-- <li class="sidenav-item {{ (request()->is('panel/breakRequest/*')) ? 'sidenav-item-active' : '' }}">
            <a href="/panel" class="d-flex align-items-center">
                <span class="sidenav-item-icon mr-10">
                    @include('web.default.panel.includes.sidebar_icons.noticeboard')
                </span>
                <span class="font-14 text-dark-blue font-weight-500">{{ trans('panel.add_break_request') }}</span>
            </a>
        </li> --}}
    ...
    {{-- Enjoy onlline learning - 'sidebar' footer image  --}}
