...
<div id="panel_app">
    ...
    <div class="d-flex justify-content-end">
        @if ($authUser->isOrganizationManager() || $authUser->isOrganizationSubManager() || $authUser->isOrganizationStaff() )
            @include(getTemplate(). '.panel.includes.organization_manager_sidebar')
        @else
