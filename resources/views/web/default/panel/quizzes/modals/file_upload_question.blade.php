<div id="fileUploadQuestionModal" class="@if(!empty($quiz)) fileUploadQuestionModal{{ $quiz->id }} @endif {{ empty($question_edit) ? 'd-none' : ''}}">
    <div class="custom-modal-body">
        ...
        <div class="quiz-questions-form" data-action="/panel/quizzes-questions/{{ empty($question_edit) ? 'store' : $question_edit->id.'/update' }}">
            ...
            <input type="hidden" name="ajax[type]" value="{{ \App\Models\QuizzesQuestion::$fileUpload }}">
            <div class="row mt-25">
