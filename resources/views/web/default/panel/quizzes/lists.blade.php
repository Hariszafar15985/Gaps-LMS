                            ...
                            <div class="form-group">
                                ...
                                <select name="quiz_id" class="form-control select2" data-placeholder="{{ trans('public.all') }}">
                                    ...
                                    @foreach($allQuizzesLists as $allQuiz)
                                        <option value="{{ $allQuiz->id }}" @if(request()->get('quiz_id') == $allQuiz->id) selected @endif>
                                            {{ $allQuiz->title .' ( '. ($allQuiz->textLesson ? $allQuiz->textLesson->title  : ($allQuiz->webinar ? $allQuiz->webinar->title : '')).')' }}
                                        </option>
                                    @endforeach
                                </select>
                            </div>
