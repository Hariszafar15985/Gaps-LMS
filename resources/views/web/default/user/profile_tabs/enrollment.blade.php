...
<div class="mt-20 row">
    ...
    @php
        ...
        "contact_number" => "+921232132132"
        "send_result_to_employer" => 0 */
            ...
            <div class="card">
                <div class="card-body">
                    <div class="row mt-20 mb-20">
                        <div class="col">
                            <h3 class="float-left">{{trans('public.user_details')}}</h3>
                            <div class="float-right">
                                <a href="{{ url('/users/'.$userInformation['user_id'].'/download-enrollment-pdf') }}"><button type="button" class="btn btn-primary">Download PDF</button></a>
                            </div>
                            <div class="clearfix"></div>
        @endif
                                <div class="row mt-20">
                                    <div class="font-16 text-dark-blue font-weight-bold col-12 col-md-2 ">{{ $headings[$key] }} : </div>
