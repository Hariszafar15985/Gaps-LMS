...
<nav id="navbar" class="navbar navbar-expand-lg navbar-light">
    ...
    <div class="container-fluid">
        <div class="d-flex align-items-center justify-content-between w-100">
            <a class="navbar-brand navbar-order mr-0" href="/panel">
                @if(!empty($generalSettings['footer_logo']))
                    <img src="{{ $generalSettings['footer_logo'] }}" class="img-cover" alt="site logo">
                @endif
            </a>
            ...
            <div class="nav-icons-or-start-live navbar-order">
                @if (empty($authUser))
                    <a href="/login" class="py-5 px-10 mr-10 btn d-lg-flex btn btn-sm btn-primary nav-start-a-live-btn font-14">{{ trans('auth.login') }} </a>
                @endif
