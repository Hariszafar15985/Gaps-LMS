<div class="main-sidebar">
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
                ...
                <li class="nav-item dropdown {{ (request()->is('admin/quizzes*')) ? 'active' : '' }}">
                    ...
                    <ul class="dropdown-menu">
                        <li class="{{ (request()->is('admin/quizzes')) ? 'active' : '' }}">
                            <a class="nav-link" href="/admin/quizzes">{{ trans('admin/main.quizzes') }}</a>
                        </li>
                        <li class="{{ (request()->is('admin/quizzes/pending')) ? 'active' : '' }}">
                            <a class="nav-link" href="/admin/quizzes/pending">{{ trans('admin/main.pending_quizzes') }}</a>
                        </li>
                        <li class="{{ (request()->is('admin/quizzes/new')) ? 'active' : '' }}">
                            <a class="nav-link" href="/admin/quizzes/new">{{ trans('admin/main.add_quizzes') }}</a>
                        </li>
                    </ul>
                </li>
            @endcan()
            ...
            <li class="nav-item dropdown {{ (request()->is('admin/breakRequests*')) ? 'active' : '' }}">
                <a href="#" class="nav-link has-dropdown" data-toggle="dropdown">
                    <i class="fas fa-clock"></i>
                    <span>{{ trans('admin/main.break_requests') }}</span>
                </a>
                <ul class="dropdown-menu">
                    <li class="{{ (request()->is('admin/breakRequests')) ? 'active' : '' }}">
                        <a class="nav-link" href="{{route('admin.manage.breakRequests')}}">
                            {{ trans('admin/main.list') }}
                        </a>
                    </li>
                    <li class="{{ (request()->is('admin/breakRequests/pending')) ? 'active' : '' }}">
                        <a class="nav-link" href="{{route('admin.breakRequests.pending')}}">
                            {{ trans('admin/main.pending_requests') }}
                        </a>
                    </li>
                </ul>
            </li>
            ...
            @if($authUser->can('admin_users') or
                ...
                $authUser->can('admin_organizations_list') or
            ...
            @can('admin_organizations_list')
                <li class="nav-item dropdown {{ (request()->is('admin/organizations') or request()->is('admin/organizations/sites') or request()->is('admin/organizations/manage/managers') or request()->is('admin/organizations/manage/sub_managers') or request()->is('admin/organizations/manage/consultants') or request()->is('admin/students') or request()->is('admin/admin/appointments') or request()->is('admin/organizations/new/organization') or request()->is('admin/organizations/sites/new') or request()->is('admin/organizations/new/organization_manager') or request()->is('admin/organizations/new/organization_sub_manager') or request()->is('admin/organizations/new/organization_staff') or request()->is('admin/organizations/new/user')) ? 'active' : '' }}">
                    <a href="#" class="nav-link has-dropdown" data-toggle="dropdown">
                        <i class="fas fa-users"></i>
                        <span>{{ trans('admin/main.organizations') }}</span>
                    </a>

                    <ul style="line-height: 35px;" class="dropdown-menu">
                        @can('admin_organizations_list')
                            <li class="{{ (request()->is('admin/organizations') or request()->is('admin/organizations/new/organization')) ? 'active' : '' }}">
                                <a style="display:inline; padding-right: 0px;" class="nav-link" href="/admin/organizations">{{ trans('admin/main.organizations') }}</a>
                                <span>&nbsp;/&nbsp;</span>
                                <a style="display:inline; padding-left: 0px;" class="nav-link" href="/admin/organizations/new/organization">{{ trans('admin/main.new') }}</a>
                            </li>
                        @endcan()

                        @can('admin_organizations_list')
                            <li class="{{ (request()->is('admin/organizations/sites') or request()->is('admin/organizations/sites/new')) ? 'active' : '' }}">
                                <a style="display:inline; padding-right: 0px;" class="nav-link" href="/admin/organizations/sites">{{ trans('admin/main.organization_sites') }}</a>
                                <span>&nbsp;/&nbsp;</span>
                                <a style="display:inline; padding-left: 0px;" class="nav-link" href="/admin/organizations/sites/new">{{ trans('admin/main.new') }}</a>
                            </li>
                        @endcan()

                        @can('admin_organizations_list')
                            <li class="{{ (request()->is('admin/organizations/manage/managers') or request()->is('admin/organizations/new/organization_manager')) ? 'active' : '' }}">
                                <a style="display:inline; padding-right: 0px;" class="nav-link" href="/admin/organizations/manage/managers">{{ trans('admin/main.higher_managers') }}</a>
                                <span>&nbsp;/&nbsp;</span>
                                <a style="display:inline; padding-left: 0px;" class="nav-link" href="/admin/organizations/new/organization_manager">{{ trans('admin/main.new') }}</a>
                            </li>
                        @endcan()

                        @can('admin_organizations_list')
                            <li class="{{ (request()->is('admin/organizations/manage/sub_managers') or request()->is('admin/organizations/new/organization_sub_manager')) ? 'active' : '' }}">
                                <a style="display:inline; padding-right: 0px;" class="nav-link" href="/admin/organizations/manage/sub_managers">{{ trans('admin/main.managers') }}</a>
                                <span>&nbsp;/&nbsp;</span>
                                <a style="display:inline; padding-left: 0px;" class="nav-link" href="/admin/organizations/new/organization_sub_manager">{{ trans('admin/main.new') }}</a>
                            </li>
                        @endcan()

                        @can('admin_organizations_list')
                            <li class="{{ (request()->is('admin/organizations/manage/consultants') or request()->is('admin/organizations/new/organization_staff')) ? 'active' : '' }}">
                                <a style="display:inline; padding-right: 0px;" class="nav-link" href="/admin/organizations/manage/consultants">{{ trans('admin/main.consultants') }}</a>
                                <span>&nbsp;/&nbsp;</span>
                                <a style="display:inline; padding-left: 0px;" class="nav-link" href="/admin/organizations/new/organization_staff">{{ trans('admin/main.new') }}</a>
                            </li>
                        @endcan()

                        @can('admin_organizations_list')
                            <li class="{{ (request()->is('admin/students') or request()->is('admin/organizations/new/user')) ? 'active' : '' }}">
                                <a style="display:inline; padding-right: 0px;" class="nav-link" href="/admin/students">{{ trans('admin/main.students') }}</a>
                                <span>&nbsp;/&nbsp;</span>
                                <a style="display:inline; padding-left: 0px;" class="nav-link" href="/admin/organizations/new/user">{{ trans('admin/main.new') }}</a>
                            </li>
                        @endcan()

                        @can('admin_organizations_list')
                            <li class="{{ (request()->is('admin/appointments')) ? 'active' : '' }}">
                                <a class="nav-link" href="/admin/appointments">{{ trans('admin/main.appointments') }}</a>
                            </li>
                        @endcan()
            ...
            @can('admin_settings')
                ...
                <li>
                    <a href="{{url('laravel-filemanager')}}" class="nav-link" target="_blank">
                        <i class="fas fa-file"></i>
                        <span>File Manager</span>
                    </a>
                </li>

                {{--  Laravel File anager Ends  --}}
