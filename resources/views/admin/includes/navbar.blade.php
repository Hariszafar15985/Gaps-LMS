...
if(isset($generalSettings['dash_color']) && !empty($generalSettings['dash_color'])) {

    $navColor = "background-color: " . str_replace("#", "", $generalSettings['dash_color']) . " !important;";
}
@endphp
...
<div class="navbar-bg" style="{{$navColor}}"></div>
