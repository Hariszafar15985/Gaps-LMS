                                        ...
                                        <tr class="text-center">
                                            ...
                                            <td width="120" class="btn-sm">
                                                ...
                                                @can('admin_webinars_edit')
                                                    <a href="{{route('admin.webinar_duplicate', ['id' => $webinar->id])}}" class="btn-transparent btn-sm text-primary mt-1" data-toggle="tooltip" data-placement="top" title="{{ trans('admin/main.duplicate') }}">
