...
@section('content')
    ...
    <section class="section">
        <div class="section-header">
            <h1>{{ trans('public.sub_managers') }}</h1>
        </div>
    </section>
    ...
    <section class="mt-35">
        <h2 class="section-title">{{ trans('panel.sub_managers_list') }}</h2>
                                        ...
                                        {{-- <td class="text-right align-middle">
                                            <div class="btn-group dropdown table-actions">
                                                ...
                                                <div class="dropdown-menu">
                                                    ...
                                                    <a href="/panel/manage/sub_managers/{{ $user->id }}/edit" class="btn-transparent webinar-actions d-block mt-10">{{ trans('public.edit') }}</a>
                                                    <a href="/panel/manage/sub_managers/{{ $user->id }}/delete" class="webinar-actions d-block mt-10 delete-action">{{ trans('public.delete') }}</a>
                                                </div>
                                            </div>
                                        </td> --}}
