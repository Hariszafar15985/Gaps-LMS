...
@section('content')
    ...
    <section class="section">
        <div class="section-header">
            <h1>{{ trans('public.managers') }}</h1>
        </div>
    </section>

    <section>
        {{-- <h2 class="section-title">{{ trans('public.managers') }}</h2> --}}
    ...
    <section class="mt-35">
        ...
        @else
            ...
            @include(getTemplate() . '.includes.no-result',[
                ...
                'btn' => ['url' => route('panel.manage.create.user', ['user_type' => 'managers']),'text' => trans('panel.add_a_manager')]
            ])
        @endif
