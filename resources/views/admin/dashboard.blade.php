                    ...
                    @if(!empty($getTotalSalesStatistics))
                        <div class="card card-statistic-2">
                            <div class="card-stats">
                                ...
                                <div class="card-stats-items">
                                    <div class="card-stats-item cursor-pointer text-center w-100">
                                        <a class="saleStats align-items-center" data-toggle="modal" data-target="#resultsModal" href="" data-url="{{route('admin.get.fetchCurrentSaleStats', ['period' => 'day'])}}" >
                                            <div class="card-stats-item-count">{{ $getTotalSalesStatistics['todaySales'] }}</div>
                                            <div class="card-stats-item-label d-inline-block">{{trans('admin/main.today')}}</div>
                                        </a>
                                    </div>

                                    <div class="card-stats-item cursor-pointer text-center w-100">
                                        <a class="saleStats align-items-center" data-toggle="modal" data-target="#resultsModal" href="" data-url="{{route('admin.get.fetchCurrentSaleStats', ['period' => 'month'])}}" >
                                            <div class="card-stats-item-count">{{ $getTotalSalesStatistics['monthSales'] }}</div>
                                            <div class="card-stats-item-label d-inline-block">{{trans('admin/main.this_month')}}</div>
                                        </a>
                                    </div>
                                    
                                    <div class="card-stats-item cursor-pointer text-center w-100">
                                        <a class="saleStats align-items-center" data-toggle="modal" data-target="#resultsModal" href="" data-url="{{route('admin.get.fetchCurrentSaleStats', ['period' => 'year'])}}" >
                                            <div class="card-stats-item-count">{{ $getTotalSalesStatistics['yearSales'] }}</div>
                                            <div class="card-stats-item-label d-block">{{trans('admin/main.this_year')}}</div>
                                        </a>
                                    </div>
                                </div>
                            </div>
            ...
            @can('admin_general_dashboard_new_reviews')
                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                    <a class="card card-statistic-1">
                        ...
                        <div class="card-wrap">
                            <div class="card-header">
                                <h4>Pending Review Assessments</h4>
                            </div>
                            <div class="card-body">
    ...
    <div id="resultsModal" class="modal fade" role="dialog">
        <div class="modal-dialog" style="max-width:90%;">
            ...
            <div class="modal-header">
                <h4 class="modal-title mx-auto">Modal Header</h4>
...
@push('scripts_bottom')
    ...
    <script>
        ...
        @can('admin_general_dashboard_total_sales_statistics')
            @if(!empty($getTotalSalesStatistics))
                $('.card-stats-items a.saleStats').click( function(event){
