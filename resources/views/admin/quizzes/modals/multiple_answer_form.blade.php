    ...
    <div class="row">
        <div class="col-12">
            <div class="form-group">
                ...
                <input type="text" name="answers[{{ (@$answer) ? $answer->id : 'ans' }}][title]" class="form-control {{ (@$answer) ? 'js-ajax-answer-title-'.$answer->id : '' }}" value="{{ (@$answer) ? $answer->title : '' }}"/>
            </div>
        </div>
    </div>
        ...
        <div class="col-12 col-md-8">
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    <input id="file{{ !empty($answer) ? $answer->id : '' }}" type="text" name="answers[{{ !empty($answer) ? $answer->id : 'ans' }}][file]" value="{{ !empty($answer) ? $answer->image : '' }}" class="form-control lfm-input"/>
                </div>
            </div>
        </div>
        <div class="col-12 col-md-4">
            <div class="form-group mt-2 d-flex align-items-center justify-content-between js-switch-parent">
                ...
                <div class="custom-control custom-switch">
                    <input id="correctAnswerSwitch{{ (@$answer) ? $answer->id : '' }}" type="checkbox" name="answers[{{ (@$answer) ? $answer->id : 'ans' }}][correct]" @if((@$answer) and @$answer->correct) checked @endif class="custom-control-input js-switch">
                    <label class="custom-control-label js-switch" for="correctAnswerSwitch{{ (@$answer) ? $answer->id : '' }}"></label>
                </div>
            </div>
        </div>
    </div>
