<div id="fillBlankQuestionModal"
    class="@if (!empty($quiz)) fillBlankQuestionModal{{ $quiz->id }} @endif {{ empty($question_edit) ? 'd-none' : '' }}">
    <div class="custom-modal-body">
        ...
        <div class="quiz-questions-form" data-action="{{ getAdminPanelUrl() }}/quizzes-questions/{{ empty($question_edit) ? 'store' : $question_edit->id.'/update' }}" method="post">
            ...
            <input type="hidden" name="type" value="{{ \App\Models\QuizzesQuestion::$fillInBlank }}">
            <div class="row mt-3">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="form-group">
                        ...
                        <textarea name="title" id="" class="summernote form-control" rows="10">{!! !empty($question_edit) ? $question_edit->title : '' !!}</textarea>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="form-group">
                        ...
                        <div name="fitb_preview" id="" class="preview_div form-inline"
                            @if (isset($question_edit->correct) && strlen($question_edit->correct) > 0) @php $answers = json_decode($question_edit->correct); @endphp
