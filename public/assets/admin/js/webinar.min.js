! function(e) {
    ...
    function a(t, a) {
        var n = t.serializeObject(),
            i = t.attr("action");
        a.addClass("loadingbar gray").prop("disabled", !0), t.find("input").removeClass("is-invalid"), t.find("textarea").removeClass("is-invalid"), e.post(i, n, function(e) {
    ...
    function n(t) {
        ...
        e.post("/admin/tickets/" + n + "/edit", l, function(t) {
            if (t && t.ticket) {
                var a = t.ticket,
                    l = '<div id="addTicketModal">';
                l += e("#webinarTicketModal").html(), l = (l += "</div>").replaceAll("/admin/tickets/store", "/admin/tickets/" + n + "/update"), Swal.fire({
                    html: l,
                    showCancelButton: !1,
                    showConfirmButton: !1,
                    customClass: {
            ...
            if (a && a.chapter) {
                ...
                o = o.replaceAll("record", s), Swal.fire({
                    ...
                    onOpen: function() {
                        ...
                        a && (a.addClass("js-edit-chapter-locale-ajax"), a.attr("data-chapter-id", i), a.attr("data-webinar-id", l))
                    }
                })
            }
        })
                ...
                o = o.replaceAll("record", s), Swal.fire({
                    ...
                    onOpen: function() {
                        ...
                        e(".datetimepicker").daterangepicker({
                            ...
                            timePicker: !0,
                            timePicker24Hour: !0,
                            startDate: moment(1e3 * n.date).toDate()
                        ...
                        var a = t.find('select[name="locale"]');
                        a && (a.addClass("js-edit-session-locale-ajax"), a.attr("data-session-id", i), a.attr("data-webinar-id", l))
                    }
                })
            }
        })
    ...
    function o(a) {
        var n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : null,
            i = a.attr("data-file-id"),
            l = a.attr("data-webinar-id"),
            o = {
                item_id: l,
                locale: n
            };
        e.post("/admin/files/" + i + "/edit", o, function(a) {
            if (a && a.file) {
                var n = a.file,
                    o = '<div id="addFilesModal">';
                o += e("#webinarFileModal").html(), o = (o = (o += "</div>").replaceAll("/admin/files/store", "/admin/files/" + i + "/update")).replaceAll("str_", "");
                var s = t();
                o = o.replaceAll("record", s), Swal.fire({
                    html: o,
                    showCancelButton: !1,
                    ...
                    onOpen: function() {
                        ...
                        Object.keys(n).forEach(function(e) {
                            if ("storage" === e) "online" === n[e] ? (t.find('[name="' + e + '"]').val(n[e]), t.find(".local-input").addClass("d-none"), t.find(".online-inputs").removeClass("d-none"), t.find(".js-downloadable-file").addClass("d-none"), t.find(".js-downloadable-file input").prop("checked", !1)) : (t.find(".local-input").removeClass("d-none"), t.find(".online-inputs").addClass("d-none"), t.find(".js-downloadable-file").removeClass("d-none"));
                            else if ("status" === e) {
                                var a = "active" === n.status;
                                t.find('[name="' + e + '"]').prop("checked", a)
                            } else if ("downloadable" === e) {
                                var i = 1 === n.downloadable || "1" === n.downloadable;
                                t.find('input[name="' + e + '"]').prop("checked", i)
                            } else t.find('[name="' + e + '"]').val(n[e])
                        });
                        var a = t.find('select[name="locale"]');
                        a && (a.addClass("js-edit-file-locale-ajax"), a.attr("data-file-id", i), a.attr("data-webinar-id", l))
                    }
                })
            }
        })
    ...
    function s(t) {
        ...
        e.post("/admin/faqs/" + n + "/edit", l, function(t) {
            if (t && t.faq) {
                var a = t.faq,
                    l = '<div id="addFAQsModal">';
                l += e("#webinarFaqModal").html(), l = (l += "</div>").replaceAll("/admin/faqs/store", "/admin/faqs/" + n + "/update"), Swal.fire({
                    html: l,
                    showCancelButton: !1,
                    showConfirmButton: !1,
                    customClass: {
                    ...
                    onOpen: function() {
                        ...
                        var l = t.find('select[name="locale"]');
                        l && (l.addClass("js-edit-faq-locale-ajax"), l.attr("data-faq-id", n), l.attr("data-webinar-id", i))
                    }
                })
            }
        })
    ...
    function d(a) {
        ...
        e.post("/admin/test-lesson/" + i + "/edit", o, function(a) {
            if (a && a.testLesson) {
                var n = a.testLesson,
                    o = t(),
                    s = '<div id="addTestLessonModal">';
                s += e("#webinarTestLessonModal").html(), s = (s = (s = (s = (s += "</div>").replaceAll("record", o)).replaceAll("/admin/test-lesson/store", "/admin/test-lesson/" + i + "/update")).replaceAll("str_", "")).replaceAll("attachments-select2", "attachments-select2-" + o), Swal.fire({
                    html: s,
                    showCancelButton: !1,
                    showConfirmButton: !1,
                    customClass: {
                    ...
                    onOpen: function() {
                        var t = e("#addTestLessonModal"),
                            a = [];
                        Object.keys(n).forEach(function(e) {
                            if ("attachments" === e) n[e] && n[e].length && Object.keys(n[e]).forEach(function(t) {
                                var i = n[e][t];
                                i && a.push(i.file_id)
                            });
                            else if ("status" === e) {
                                var i = "active" === n.status;
                                t.find('[name="' + e + '"]').prop("checked", i)
                            } else {
                                t.find('[name="' + e + '"]').val(n[e]);
                                if(e === 'drip_feed') {
                                    if (parseInt(n[e]) == 1) {
                                        t.find(".feedDate").css('display', '');
                                    }
                                     else {
                                        t.find(".feedDate").css('display', 'none');
                                    }
                                }
                            }
                            ...
                            multiple: !0,
                            width: "100%"
                        }), e(".attachments-select2-" + o).val(a).change();
                        var s = t.find(".js-content-summernote");
                        s.length && (s.val(n.content), s.summernote({
                            tabsize: 2,
                            height: 400,
                            callbacks: {
                        ...
                        var d = t.find('select[name="locale"]');
                        d && (d.addClass("js-edit-text-locale-ajax"), d.attr("data-text-id", i), d.attr("data-webinar-id", l))
                    }
                })
            }
        })
    ...
    e.fn.serializeObject = function() {
        ...
        t.preventDefault();
        var n = e(this);
        a(e("#addTicketModal form"), n)
    }), e("body").on("click", "#webinarAddChapter", function(a) {
        a.preventDefault();
        var n = t(),
            i = e("#webinarChapterModal");
        i.find("input").prop("disabled", !1);
        var l = '<div id="addChapterModal">';
        l += i.html(), l = (l += "</div>").replaceAll("record", n), Swal.fire({
            html: l,
            showCancelButton: !1,
            showConfirmButton: !1,
            customClass: {
    ...
    }), e("body").on("click", "#webinarAddSession", function(a) {
        a.preventDefault();
        var n = t(),
            i = e("#webinarSessionModal");
        i.find("input").prop("disabled", !1);
        var l = '<div id="addSessionModal">';
        l += i.html(), l = (l += "</div>").replaceAll("record", n), Swal.fire({
            html: l,
            showCancelButton: !1,
            showConfirmButton: !1,
        ...
        var a = e(this).closest(".session-form"),
            n = this.value;
        a.find(".js-zoom-not-complete-alert").addClass("d-none"), "big_blue_button" === n ? (a.find(".js-local-link").addClass("d-none"), a.find(".js-api-secret").removeClass("d-none"), a.find(".js-moderator-secret").removeClass("d-none")) : "zoom" === n ? (a.find(".js-local-link").addClass("d-none"), a.find(".js-api-secret").addClass("d-none"), a.find(".js-moderator-secret").addClass("d-none")) : (a.find(".js-local-link").removeClass("d-none"), a.find(".js-api-secret").removeClass("d-none"), a.find(".js-moderator-secret").addClass("d-none"))
    }), e("body").on("click", "#saveSession", function(t) {
        t.preventDefault();
        var n = e(this);
        a(e("#addSessionModal form"), n)
    }), e("body").on("click", "#webinarAddFile", function(a) {
        a.preventDefault();
        var n = t(),
            i = '<div id="addFilesModal">';
        i += e("#webinarFileModal").html(), i = (i = (i += "</div>").replaceAll("str_", "")).replaceAll("record", n), Swal.fire({
            html: i,
            showCancelButton: !1,
            showConfirmButton: !1,
            customClass: {
        ...
        t.preventDefault();
        var n = e(this);
        a(e("#addFilesModal form"), n)
    }), e("body").on("click", "#saveChapter", function(t) {
        t.preventDefault();
        var n = e(this);
        a(n.closest("form"), n)
        ...
        t.preventDefault();
        var n = e(this);
        a(e("#addPrerequisitesModal form"), n)
        ...
        e.post("/admin/prerequisites/" + n + "/edit", l, function(t) {
            var a = this;
            if (t && t.prerequisite) {
                var i = t.prerequisite,
                    l = '<div id="addPrerequisitesModal">';
                l += e("#webinarPrerequisitesModal").html(), l = (l = (l = (l += "</div>").replaceAll("prerequisites-select", "prerequisites-select2")).replaceAll("/admin/prerequisites/store", "/admin/prerequisites/" + n + "/update")).replaceAll("str_", ""), Swal.fire({
                    html: l,
                    showCancelButton: !1,
                    showConfirmButton: !1,
                    customClass: {
        ...
        e.post("/admin/webinar-quiz/" + n + "/edit", l, function(t) {
            var a = this;
            var dripFeed
            var dripFeedContent = "<option value='1'>True</option> <option value='0'>False</option>"
            if (t && t.webinarQuiz) {
                var i = t.webinarQuiz,
                    l = '<div id="addQuizModal">';
                    console.log(i.show_after_days)
                    if(i.drip_feed == 1) {
                        dripFeed = "True"
                    }else{
                        dripFeed = "False"
                    ...
                    $(".selectFeed").html("")
                    $(".selectFeed").append("<option selected value='"+ i.drip_feed +"'>"+ dripFeed +"</option>")
                    $(".selectFeed").append(dripFeedContent)
                    if(i.drip_feed == 1){
                        $(".feedDate").addClass("d-block")
                        $(".feedDateField").attr("value", i.show_after_days)
                    }

                l += e("#quizzesModal").html(), l = (l = (l += "</div>").replaceAll("/admin/webinar-quiz/store", "/admin/webinar-quiz/" + n + "/update")).replaceAll("quiz-select2", "quiz-select22"), Swal.fire({
                    html: l,
                    showCancelButton: !1,
                    showConfirmButton: !1,
                    customClass: {
                    ...
                    onOpen: function() {
                        e(".quiz-select22").append('<option selected="selected" value="' + i.id + '">' + i.title + "</option>"), e(".quiz-select22").select2({
                            ...
                            allowClear: !0,
                            width: "100%"
                        }), e("#addQuizModal").find('[name="chapter_id"]').val(i.chapter_id), e("#addQuizModal select[name='chapter_id']").trigger("change");
                        if (typeof i.text_lesson_id !== 'undefined') {
                            setTimeout(() => {
                                e("#addQuizModal select[name='lesson_id']").val(i.text_lesson_id);
                            }, 1000);
                        }
                    }
                })
        ...
        "online" === a ? (n.find(".local-input").addClass("d-none"), n.find(".local-input input").val(""), n.find(".online-inputs").removeClass("d-none"), n.find(".js-downloadable-file").addClass("d-none"), n.find(".js-downloadable-file input").prop("checked", !1)) : (n.find(".local-input input").val(""), n.find(".local-input").removeClass("d-none"), n.find(".online-inputs").addClass("d-none"), n.find(".js-downloadable-file").removeClass("d-none"), n.find(".js-downloadable-file input").prop("checked", !0))
    }), e("body").on("click", "#webinarAddTestLesson", function(a) {
        a.preventDefault();
        var n = t(),
            i = '<div id="addTestLessonModal">';
        i += e("#webinarTestLessonModal").html(), i = (i = (i += "</div>").replaceAll("record", n)).replaceAll("attachments-select2", "attachments-select2-" + n), Swal.fire({
            html: i,
            showCancelButton: !1,
            showConfirmButton: !1,
            customClass: {
            ...
            width: "48rem",
            onOpen: function() {
                e(".attachments-select2-" + n).select2({
                    multiple: !0,
                    width: "100%"
                });
                var t = e("#addTestLessonModal"),
                    a = t.find(".js-content-summernote");
                a.length && a.summernote({
                    tabsize: 2,
                    height: 400,
                    callbacks: {
                        onChange: function(e, a) {
        ...
        t.preventDefault();
        var n = e(this);
        handleAddLessonForm(e("#addTestLessonModal form"), n)
        // a(e("#addTestLessonModal form"), n)
    }) , e("body").on("click", ".edit-test-lesson", function(t) {
        t.preventDefault();
        var a = e(this);
        loadingSwl(), d(a)
    }), e("body").on("change", ".js-edit-text-locale-ajax", function(t) {
        t.preventDefault();
        var a = e(this),
            n = a.val();
        d(a, n)
    ...
    }), e("body").on("change", "#addQuizModal select[name='chapter_id']", function() {
        let chapterId = e("#addQuizModal select[name='chapter_id']").val();
        let requestUrl = `/admin/test-lesson/getAllLessonsByChapterId/${chapterId}`;
        e.ajax({
            type: 'GET',
            url: requestUrl,
            dataType: 'json',
            success: function(response) {
                if (Object.keys(response).length > 0 && response.success) {
                    if (typeof response.data !== 'undefined' && response.data.length > 0) {
                        ...
                        e("#addQuizModal select[name='lesson_id'] option:not(.defaultVal)").remove();
                        for (let i = 0; i < data.length; i++) {
                            let option = `<option value='${data[i]['id']}'>${data[i]['title']}</option>`;
                            e("#addQuizModal select[name='lesson_id']").append(option);
                        }
                        /*select the very first value*/
                        e("#addQuizModal select[name='lesson_id']").val(data[0]['id']);
                    }
                }
            },
