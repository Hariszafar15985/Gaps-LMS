!(function (t) {
    ...
    t("body").on("click", "#add_multiple_question", function (a) {
        ...
        var o = e();
        n.find(".panel-file-manager").attr("data-input", o),
            n.find(".lfm-input").attr("id", o),
            n.find(".main-answer-row").removeClass("main-answer-row").addClass("main-answer-box"),
            Swal.fire({ html: n.html(), showCancelButton: !1, showConfirmButton: !1, customClass: { content: "p-0 text-left" }, width: "48rem" });
    }),
        ...
        t("body").on("click", "#add_descriptive_question", function (e) {
            ...
            Swal.fire({ html: i.html(), showCancelButton: !1, showConfirmButton: !1, customClass: { content: "p-0 text-left" }, width: "48rem" });
        }),
        t("body").on("change", ".js-switch", function () {
            var e = t(this);
            e.closest(".js-switch-parent");
            this.checked &&
                (t(".js-switch").each(function () {
        ...
        t("body").on("click", ".save-question", function (e) {
            ...
            a.addClass("loadingbar primary").prop("disabled", !0),
                i.find("input").removeClass("is-invalid"),
                i.find("textarea").removeClass("is-invalid"),
                t
                    .post(r, n, function (t) {
                        t &&
                            200 === t.code &&
        ...
        t("body").on("click", ".edit_question", function (a) {
            ...
            loadingSwl(),
                t.get("/panel/quizzes-questions/" + i + "/edit", function (a) {
                    if (a && a.html) {
