...
(function ($) {
  ...
  $('body').on('click', '#saveAndPublish', function (e) {
    e.preventDefault();
    $('#webinarForm .include-section').remove(); //removing the accordians' data from payload
  ...
  $('body').on('click', '.js-add-course-content-btn, .add-new-interactive-file-btn', function (e) {
    ...
    switch (type) {
      ...
      case 'quiz':
        ...
        //ajx call to get the textLessons for a chapter
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                $('#selectedSelectionTextlessonInQuizForm').empty().append(
                ...
                $.each(textLessons, function(key , value) {
                    $('#selectedSelectionTextlessonInQuizForm').append($('<option>', {
                        value: value.id,
                        text: value.title
                    }));
                });
