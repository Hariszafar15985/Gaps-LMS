...
Route::group(['prefix' => 'admin', 'namespace' => 'Admin', 'middleware' => 'web'], function () {
    ...
    Route::group(['middleware' => 'admin'], function () {
        ...
        Route::group(['prefix' => 'dashboard'], function () {
            ...
            Route::get('/fetchCurrentSaleStats/{period?}', 'DashboardController@fetchCurrentSaleStats')->name('admin.get.fetchCurrentSaleStats');
        });
        ...
        Route::group(['prefix' => 'students'], function () {
            ...
            Route::get('/{id}/enrol', 'UserController@enrolStudents');
            Route::get('/course/{slug}/{payment_type}/{id}', 'WebinarController@processEnrolment');
            // Route::get('/course/{slug}/free/{id}', 'WebinarController@free');
        });
        ...
        Route::group(['prefix' => 'organizations'], function () {
            ...
            Route::get('/sites', 'OrganizationController@listOrganizationSites')->name('admin.organizations.sites');
            Route::get('/sites/new', 'OrganizationController@createOrganizationSite')->name('admin.organizations.sites.create');
            Route::post('/sites/new', 'OrganizationController@storeOrganizationSite')->name('admin.organizations.sites.store');
            Route::get('/sites/edit/{id}', 'OrganizationController@editOrganizationSite')->name('admin.organizations.sites.edit');
            Route::post('/sites/edit/{id}', 'OrganizationController@updateOrganizationSite')->name('admin.organizations.sites.update');
            Route::get('/sites/delete/{id}', 'OrganizationController@deleteOrganizationSite')->name('admin.organizations.sites.delete');
            Route::get('/manage/{user_type}', 'OrganizationController@manageUserLists');
            Route::get('/new/{role_type}', 'OrganizationController@addNewUser');
            Route::get('/meetings', 'OrganizationController@getOrganizationMeetings');
            Route::get('/excel', 'OrganizationController@exportExcelOrganizations');
            Route::get('/query', 'OrganizationController@fetchAjaxUsers')->name('admin.organizations.query');
        });

        Route::group(['prefix' => 'breakRequests'], function () {
            Route::get('/', 'UserBreaksController@index')->name('admin.manage.breakRequests');
            Route::get('/pending', 'UserBreaksController@index')->name('admin.breakRequests.pending');
            Route::get('/approve/{id}', 'UserBreaksController@updateStatus')->name('admin.breakRequest.approve');
            Route::get('/reject/{id}', 'UserBreaksController@updateStatus')->name('admin.breakRequest.reject');
            Route::get('/delete/{id}', 'UserBreaksController@destroy')->name('admin.breakRequest.delete');
            Route::post('/save', 'UserBreaksController@store')->name('admin.breakRequest.save');
        });
        Route::group(['prefix' => 'placementNote'], function () {
            // Route::get('/', 'UserBreaksController@index')->name('admin.manage.breakRequests');
            // Route::get('/pending', 'UserBreaksController@index')->name('admin.breakRequests.pending');
            // Route::get('/approve/{id}', 'UserBreaksController@updateStatus')->name('admin.breakRequest.approve');
            // Route::get('/reject/{id}', 'UserBreaksController@updateStatus')->name('admin.breakRequest.reject');
            // Route::get('/delete/{id}', 'UserBreaksController@destroy')->name('admin.breakRequest.delete');
            Route::post('/save', 'PlacementNotesController@store')->name('admin.placementNotes.save');
        });

        Route::group(['prefix' => 'users'], function () {
            Route::get('/create', 'UserController@create');
            Route::get("/show-to-users", 'TextLessonsController@showManually')->name("show-manually");
            Route::get("/drip-feed-quiz", 'DripFeedQuizController@showManually')->name("quiz.show-manually");
            Route::get("/drip-feed-file", 'FileController@showManually')->name("file.show-manually");
        ...
        Route::group(['prefix' => 'fetch'], function() {
            Route::post('/getSiteManagers', 'UserController@fetchSiteManagers')->name('admin.get.organization.site.managers');
            Route::post('/getOrganizationSites', 'UserController@fetchOrganizationSites')->name('admin.get.organization.sites');
        });
        ...
        Route::group(['prefix' => 'notifications'], function () {
            ...
            // Route::get('/enroll', 'NotificationsController@confirmEnrollment');
        ...
        Route::group(['prefix' => 'webinars'], function () {
            ...
            Route::get('/{id}/edit', 'WebinarController@edit')->name('admin.webinar_edit');
            Route::get('/{id}/duplicate', 'WebinarController@duplicate')->name('admin.webinar_duplicate');
        ...
        Route::group(['prefix' => 'quizzes'], function () {
            ...
            Route::get('/pending', 'QuizController@pending');
            Route::post('/store', 'QuizController@store');
            Route::get('/{id}/edit', 'QuizController@edit')->name('admin_edit_quiz');
            ...
            Route::get('/{quizResultId}/resultDetail', 'QuizController@showResult')->name('admin_quiz_result_detail');
            Route::get('/{id}/results/excel', 'QuizController@resultsExportExcel');
            Route::get('/pending/excel', 'QuizController@pendingExportExcel');
            Route::get('/result/{result_id}/delete', 'QuizController@resultDelete');
            Route::get('/excel', 'QuizController@exportExcel');
            Route::post("/questions/reorder", 'QuizController@reOrderQuestions')->name("admin.questions.sort");
        });
        ...
        Route::group(['prefix' => 'text-lesson'], function () {
            ...
            Route::get('/audio/{id}/delete', 'TextLessonsController@deleteAudio')->name("admin.delete.audio");
        });
        ...
        Route::group(['prefix' => 'financial'], function () {
            ...
            Route::group(['prefix' => 'sales'], function () {
                ...
                Route::get('/pushSaleToXero/{saleId}', 'SaleController@pushSaleToXero')->name('admin_push_sale_to_xero');
        ...
        Route::group(['prefix' => 'settings'], function () {
            ...
            Route::post('/sidebar/save', 'SettingsController@saveSidebar');
            Route::get('/course/customization', 'SettingsController@courseCustomization')->name('settings.course.customization');
            Route::post('/course/customization', 'SettingsController@courseCustomizationStore')->name('settings.course.customization.store');
