...
class QuizzesPendingExport implements FromCollection, WithHeadings, WithMapping
{
    protected $results;
    ...
    public function headings(): array
    {
        return [
            ...
            trans('admin/pages/webinars.course'),
            trans('quiz.student'),
    ...
    public function map($result): array
    {
        return [
            ...
            $result->quiz->teacher->organization->full_name,
            $result->user_grade,
