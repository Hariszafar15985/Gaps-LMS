...
class Setting extends Model implements TranslatableContract
{
    ...
    static $seoMetas, $socials,
        ...
        $financial, $offlineBanks, $siteBankAccounts, $referral, $currencySettings,
        $homeHero, $homeHero2, $homeVideoOrImage,
        $pageBackground, $customCssJs,
        $reportReasons, $notificationTemplates,
        $contactPage, $Error403Page, $Error404Page, $navbarLink, $panelSidebar, $findInstructors, $rewardProgram, $rewardsSettings, $storeSettings,
    ...
    static $organizationFinancial = 'organization_financial';
