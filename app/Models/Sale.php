...
class Sale extends Model
{
    ...
    public static $xeroSaleItemPrefixes = [
        'webinar'       =>  'WEBINAR',
        'course'        =>  'WEBINAR',
        'text_lesson'   =>  'WEBINAR',
        'meeting'       =>  'MEETING',
    ...
    {
        return $this->belongsTo('App\User', 'buyer_id', 'id')->withTrashed();
    }
    ...
    {
        return $this->hasOne('App\Models\Sale', 'id', 'sale_reference_id');
    }

    public function isReferenceFor()
    {
        return $this->belongsTo('App\Models\Sale', 'id', 'sale_reference_id');
    }

    public function paidFor()
    {
        return $this->hasOne('App\User', 'id', 'paid_for')->withTrashed();
    }
