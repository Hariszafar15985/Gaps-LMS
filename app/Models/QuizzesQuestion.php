...
class QuizzesQuestion extends Model implements TranslatableContract
{
    ...
    static $fillInBlank = 'fillInBlank';
    static $matchingListText = 'matchingListText';
    static $matchingListImage = 'matchingListImage';
    static $fileUpload = 'fileUpload';
    static $informationText = 'information_text';
