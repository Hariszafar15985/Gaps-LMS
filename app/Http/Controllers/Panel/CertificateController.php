...
class CertificateController extends Controller
{
    ...
    public function lists(Request $request)
    {
        ...
        if (!$user->isUser()) {
           ...
           /* echo '<br>pageTitle.:'.trans('quiz.certificates_lists').
                '<br>quizzes.:'.$quizzes.
                '<br>activeQuizzes.:'.$activeQuizzes.
                '<br>achievementsCount.:'.$achievementsCount.
                '<br>avgGrade.:' .round($avgGrade, 2).
                '<br>failedResults.:'.$failedResults.
                '<br>userWebinars.:' . $userWebinars.
                '<br>userAllQuizzes.:'.$userAllQuizzes;
*/
