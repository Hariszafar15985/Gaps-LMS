...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        ...
        'drip-feed' => \App\Http\Middleware\DripFeedLock::class,
        'quiz-drip-lock' => \App\Http\Middleware\QuizDripLock::class,
        'drip-file' => \App\Http\Middleware\FileDripFeed::class,
        'webinar.access' => \App\Http\Middleware\WebinarAccess::class,
